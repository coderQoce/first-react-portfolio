  ...
  return (
    <section className="contact section" id="contact">
      ...
      <div className="contact_container container grid">
        ...
        <div className="contact_content">
          <h3 className="contact_title">Bring your work</h3>
          ...
          <form ref={form} onSubmit={sendEmail} className="contact_form">
            ...
            <div className="contact_form-div contact_form-area">
              ...
              <textarea name="project" cols="30" rows="10" className="contact_form-input" placeholder='Describe your Project' required></textarea>
            </div>
            ...
            {/* Status Notification */}
            {status && (
              <div className={`contact_status ${status === 'SUCCESS' ? 'success' : 'error'}`}>
                {status === 'SUCCESS' ? (
